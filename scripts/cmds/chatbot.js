...
module.exports = {
  ...
  langs: {
    en: {
      turnedOn: "Le chatbot est activé ! Parlez moi comme à un humain 🗣️ ",
      turnedOff: "Le chatbot est désactivé ! Adios, Snif ",
  ...
  onStart: async function ({ args, threadsData, message, event, getLang }) {
    if (args[0] === "on" || args[0] === "off") {
      ...
      try {
        const responseMessage = await getChatbotResponse(yourMessage, "en");
