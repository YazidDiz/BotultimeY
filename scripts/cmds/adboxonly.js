module.exports = {
  ...
  langs: {
    vi: {
      ...
      turnedOnNoti:
        "Đã bật thông báo khi người dùng không phải là quản trị viên nhóm sử dụng bot",
      turnedOffNoti:
        "Đã tắt thông báo khi người dùng khôngkhông phải là quản trị viên nhóm sử dụng bot",
