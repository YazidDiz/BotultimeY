...
module.exports = {
    ...
    langs: {
        ...
        en: {
            ...
            help2: " ╔════ஜ۩۞۩ஜ═══╗\n   𝐋𝐈𝐒𝐓𝐄 𝐃𝐄𝐒 𝐂𝐌𝐃𝐒\n╚════ஜ۩۞۩ஜ═══╝ \n%1╭────────────⎔\n│ 𝗡𝗼𝗺𝗯𝗿𝗲 𝗱𝗲 𝗖𝗺𝗱𝘀 : [ %2 ].\n│ » Tape [ %3help <cmd> ] \n│pour voir l'usage.\n│ %4\n╰────────────⎔",
            commandNotFound: "𝗟𝗮 𝗰𝗼𝗺𝗺𝗮𝗻𝗱𝗲 \"%1\" 𝗻'𝗲𝘅𝗶𝘀𝘁𝗲 𝗽𝗮𝘀, 𝗰𝗼𝗻𝘀𝘂𝗹𝘁𝗲 𝗹𝗮 𝗹𝗶𝘀𝘁𝗲 𝗲𝗻 𝘁𝗮𝗽𝗮𝗻𝘁 ❝.𝗵𝗲𝗹𝗽❞ ",
            getInfoCommand: "╭── 𝗡𝗢𝗠 ────⭓\n│ %1\n├── 𝗜𝗡𝗙𝗢\n│ 𝗗𝗲𝘀𝗰𝗿𝗶𝗽𝘁𝗶𝗼𝗻: %2\n│ 𝗔𝘂𝘁𝗿𝗲𝘀 𝗡𝗼𝗺𝘀: %3\n│ Other names in your group: %4\n│ 𝗩𝗲𝗿𝘀𝗶𝗼𝗻: %5\n│ 𝗥𝗼𝗹𝗲: %6\n│ 𝗧𝗲𝗺𝗽𝘀 𝗱𝗲 𝗹𝗼𝗮𝗱𝗶𝗻𝗴: %7s\n│ 𝗔𝘂𝘁𝗲𝘂𝗿: %8\n├── 𝗨𝘀𝗮𝗴𝗲𝘀\n%9\n├── 𝗡𝗼𝘁𝗲𝘀\n 𝘗𝘦𝘵𝘪𝘵 𝘐𝘨𝘯𝘰𝘳𝘢𝘯𝘵 𝘷𝘢 👽\n│ 『 𝗭𝗲𝘁𝘀𝘂 𝗕𝗢𝗧 | 💎 』\n╰──────⭔",
            onlyInfo: "╭── 𝗜𝗡𝗙𝗢 ────⭓\n│𝗡𝗼𝗺 𝗱𝗲 ◎𝗹𝗮 𝗰𝗼𝗺𝗺𝗮𝗻𝗱𝗲: %1\n│ 𝗗𝗲𝘀𝗰𝗿𝗶𝗽𝘁𝗶𝗼𝗻: %2\n│ 𝗔𝘂𝘁𝗿𝗲𝘀 𝗡𝗼𝗺𝘀: %3\n│ Other names in your group: %4\n│ 𝗩𝗲𝗿𝘀𝗶𝗼𝗻: %5\n│ 𝗥𝗼𝗹𝗲: %6\n│ 𝗧𝗲𝗺𝗽𝘀 𝗱𝗲 𝗹𝗼𝗮𝗱𝗶𝗻𝗴: %7s\n│ 𝗔𝘂𝘁𝗲𝘂𝗿: %8\n╰─────────────⭓",
            onlyUsage: "╭── 𝗨𝗦𝗔𝗚𝗘 ────⭓\n│%1\n╰─────────────⭓",
    ...
    onStart: async function ({ message, args, event, threadsData, getLang, role }) {
        ...
        if (!command && !args[0] || !isNaN(args[0])) {
            ...
            for (const [name, value] of commands) {
                ...
                const categoryName = (value.config.category || "𝗡𝗼 𝗖𝗮𝘁𝗲𝗴𝗼𝗿𝘆』").toUpperCase(); // Capitalize category name
