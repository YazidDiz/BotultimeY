...
module.exports = {
  ...
  onStart: async function ({ api, message, args }) {
    try {
      ...
      const data2 = {
        prompt: p,
        cookie: "1cbGk38qsH7aJ14IPMvBE1-N0hrshHi_olcb7IZA43KqxLKZVNLXcMmTttgl3ehr2gZd2jW2NrE5BHPGKgQxHXGLBbgtaqr3kpJtkhHmtt4K6qHo3YaVL-kDSpAO-kW7BCiROXgVOu1sjJKdrmPAtpnAGFmBm6EeOX-9KOrwdw6rDHz1itSN_LIdkJryV-a3Pctzgr-Tc1vmH0jDZRindFw"
      };
